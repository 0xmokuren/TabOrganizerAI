...
[`main` への push で CI が成功するたび](https://github.com/0xmokuren/TabOrganizerAI/actions) に、[Releases](https://github.com/0xmokuren/TabOrganizerAI/releases) へ `TabOrganizerAI-{version}.zip` が公開されます。

1. [Releases](https://github.com/0xmokuren/TabOrganizerAI/releases/latest) から最新の ZIP をダウンロード
2. ZIP を展開する
...
npm run build      # dist/TabOrganizerAI-{version}.zip を生成
```
